...
public class RpqSolverApplication {
    ...
    public static void main (String[] args) throws IOException {
        ...
        SimulatedAnnealingParameters p = SimulatedAnnealingParameters.builder()
                .initialTemperature(1000.0)
                .coolingRate(0.9999995)
        ...
        SimulatedAnnealingSolution s = sa.solve((SimulatedAnnealingParameters) p);
        long durationInMillis = s.getTime() / 1_000_000;
        System.out.println("________________________ Results ________________________");
        System.out.println("Initial cmax " + Permutation.of(p.getTasks()).cmax());
        System.out.println("Cmax: " + s.getBestCmax());
        System.out.println("Time: " + durationInMillis + " ms");
        System.out.println("Best permutation: " + s.getBestPermutation().cmax() + " for " + s.getBestPermutation().id());
